...
{
	switch (evt) {
		case SBI_SSE_EVENT_LOCAL_RAS: return "RAS";
		case SBI_SSE_EVENT_LOCAL_PMU: return "PMU";
		case SBI_SSE_EVENT_LOCAL_ASYNC_PF: return "ASYNC_PF";
		case SBI_SSE_EVENT_LOCAL_DEBUG: return "DEBUG";
		case SBI_SSE_EVENT_GLOBAL_RAS: return "GLOBAL_RAS";
		case SBI_SSE_EVENT_GLOBAL_DEBUG: return "GLOBAL_DEBUG";
	}
...
static void sse_test_injection_priority(void)
{
	struct priority_test_arg hi_prio_args[] = {
		{.evt = SBI_SSE_EVENT_GLOBAL_DEBUG},
		{.evt = SBI_SSE_EVENT_LOCAL_DEBUG},
		{.evt = SBI_SSE_EVENT_LOCAL_PMU},
		{.evt = SBI_SSE_EVENT_LOCAL_ASYNC_PF},
	...
	struct priority_test_arg prio_args[] = {
		{.evt = SBI_SSE_EVENT_LOCAL_DEBUG, .prio = 0},
		{.evt = SBI_SSE_EVENT_GLOBAL_RAS, .prio = 5},
		{.evt = SBI_SSE_EVENT_LOCAL_PMU, .prio = 10},
		{.evt = SBI_SSE_EVENT_GLOBAL_DEBUG, .prio = 15},
		{.evt = SBI_SSE_EVENT_LOCAL_ASYNC_PF, .prio = 20},
		{.evt = SBI_SSE_EVENT_LOCAL_RAS, .prio = 30},
	};

	struct priority_test_arg same_prio_args[] = {
		{.evt = SBI_SSE_EVENT_LOCAL_PMU, .prio = 0},
		{.evt = SBI_SSE_EVENT_LOCAL_RAS, .prio = 10},
		{.evt = SBI_SSE_EVENT_LOCAL_ASYNC_PF, .prio = 10},
		{.evt = SBI_SSE_EVENT_GLOBAL_DEBUG, .prio = 10},
		{.evt = SBI_SSE_EVENT_LOCAL_DEBUG, .prio = 20},
	};
