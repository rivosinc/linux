...
enum sbi_fwft_feature_t {
	SBI_FWFT_MISALIGNED_DELEG		= 0x0,
	SBI_FWFT_SOFTWARE_CHECK_EXCEPTION_DELEG	= 0x1,
	SBI_FWFT_LANDING_PAD_ENABLE		= 0x2,
	SBI_FWFT_SHADOW_STACK_ENABLE		= 0x3,
	SBI_FWFT_DOUBLE_TRAP_ENABLE		= 0x4,
